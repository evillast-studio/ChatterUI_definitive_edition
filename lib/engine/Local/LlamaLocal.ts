...
export type LlamaConfig = {
    ...
    cpu_strict: boolean        // Sin esto, cpu_mask es solo un hint, no se fuerza
...
const defaultConfig = {
    ...
    cpu_mask: '4-7',           // Confirmado: A73 (2.2GHz) en este Kirin 710. 0-3 = A53 (1.7GHz, evitar)
    cpu_strict: true,          // Sin esto, cpu_mask es solo sugerencia y el SO puede migrar igual a A53
            ...
            }),
            {
                ...
                migrate: (persistedState: any, version) => {
                    ...
                    if (version === 3) {
                        ...
                        persistedState.config.cpu_strict = false
    ...
    export const useLlamaModelStore = create<LlamaState>()((set, get) => ({
        ...
        load: async (model: ModelDataType) => {
            ...
            const params: ContextParams = {
                ...
                // Nuevos en llama.rn 0.12.9
                ...(config.cpu_mask ? { cpu_mask: config.cpu_mask, cpu_strict: config.cpu_strict } : {}),
